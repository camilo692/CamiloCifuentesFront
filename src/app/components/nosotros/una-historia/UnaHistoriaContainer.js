...
const UnaHistoriaContainer = () => {
  return (
    <div className="cabecera">
      <div className="contenido-historia-container">
        <div className="contenido-historia">
          ...
          <div className="Aqu-el-protagonista-eres-t-y-nuestra-comunidad-unidos-para-hacer-la-diferencia-Toda-ayuda-puede">
            <span className={montserrat.className}>
              Aquí el protagonista eres tú y nuestra comunidad, unidos para
              hacer la diferencia. Toda ayuda puede impactar a muchas personas.
            </span>
          </div>
